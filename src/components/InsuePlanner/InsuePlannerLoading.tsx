...
import type { InsuePlannerLoadingProps } from '@/types/InsuePlannerComponents';

function InsuePlannerLoading({ SubtitleSize }: InsuePlannerLoadingProps) {
  return (
    <Container>
      <SearchingForContent />
      <Title SubtitleSize={SubtitleSize}>
...
const Title = styled.p<{ SubtitleSize: string }>`
